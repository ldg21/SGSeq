...
as previously. Splice graph features with missing annotation can be 
highlighted using argument \Rcode{color\_novel}.

<<figure-2, fig.width=4.5, fig.height=4.5>>=
plotFeatures(sgfc, geneID = 1, color_novel = "red")
@ 
