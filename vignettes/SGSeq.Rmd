...
Estimates of relative usage can be unreliable for events with low read count. If argument *min_denominator* for functions *analyzeVariants()* or *getSGVariantCounts()* is specified, estimates are set to *NA* unless at least one of $x_.^S$ or $x_.^E$ is equal or greater to the specified value.
