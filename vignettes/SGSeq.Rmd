...
![Overview of *SGSeq* data structures. Classes are shown in bold, function names in italics. $\ast$ *SGVariantCounts* assay "countsVarian5pOr3p" can be obtained from BAM files only, for details see section [Testing for differential splice variant usage].](classes.png)
