...
Note that *SGVariantCounts* objects also store raw count data. These data be used for statistical modeling, for example as suggested in section [Testing for differential splice variant usage].
